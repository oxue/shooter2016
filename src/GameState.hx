...
import refraction.control.RotationFollow;
import refraction.control.WayPointFollow;
...
class GameState extends State
{
	...
	public var s2rendersystem:Sys<AnimatedRender>;
	public var dampingSystem:Sys<DampingComponent>;
	public var controlComponent:KeyControl;
	public var collisionSystem:Sys<TileCollision>;
	public var rotationComponent:RotationControl;
	public var rotfollowSystem:Sys<RotationFollow>;
	public var velocitySystem:Sys<VelocityComponent>;
	public var animationControl:PlayerAnimation;
	//public var projectileSystem:Sys<LineProjectile>;
	...
	public var waypointfollowSystem:Sys<WayPointFollow>;
	public var s2tilemaprender:Surface2TileRender;
	...
	private function initSystems():Void
	{
		...
		rotfollowSystem = new Sys<RotationFollow>();
		...
		projectileSystem = new Sys<LineProjectile>();
		...
		s2rendersystem = new Sys<AnimatedRender>();
		timeremoverSystem = new Sys<TimeRemoverComponent>();
		spawnSystem = new Sys<Spawner>();
		waypointfollowSystem = new Sys<WayPointFollow>();
